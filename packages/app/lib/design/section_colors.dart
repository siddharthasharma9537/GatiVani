...
const Map<String, List<Color>> kSectionColors = {
  ...
  'Opinion': [Color(0xFFF5EDDF), Color(0xFF3A2A0A), Color(0xFF7A5A18)],
  'Judiciary': [Color(0xFFFBEAF0), Color(0xFF4B1528), Color(0xFF993556)],
  'Crime': [Color(0xFFFCEBEB), Color(0xFF501313), Color(0xFFA32D2D)],
  'Business': [Color(0xFFF2E7D4), Color(0xFF3A2508), Color(0xFF7A5223)],
  ...
  'Education': [Color(0xFFF2E7D4), Color(0xFF3A2508), Color(0xFF7A5223)],
  ...
  'Trending': [Color(0xFFF2E7D4), Color(0xFF3A2508), Color(0xFF7A5223)],
