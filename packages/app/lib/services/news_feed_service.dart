...
/// Fetches normalised Telugu news headlines from the feeds-news edge function.
/// The function does the cross-origin fetch + RSS parse server-side, so the web
/// app never hits a CORS wall.
